...
public:
    ...
    list<Vertex> shortestRoute(const Vertex start, const Vertex end); 
    list<Vertex> landmarkPath(const Vertex start,const Vertex middle, const Vertex end); 
    unordered_map<string, double> pageRank(const Vertex start);
